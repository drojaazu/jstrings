...
u8 euc::is_valid(u8 *data)
{
	...
	// Partial ku
	// 0xa2 - 0xa1 to 0xae, 0xba to 0xc1, 0xca to 0xd0, 0xdc to 0xea, 0xf2 to
	0xf9, 0xfe
	...
	*/
	switch(c_hi) {
		case 0xa2:
			if((c_lo >= 0xa1) & (c_lo <= 0xae) || (c_lo >= 0xba) & (c_lo <= 0xc1) ||
				 ...
				 (c_lo >= 0xf2) & (c_lo <= 0xf9) || (c_lo == 0xfe))
				return 2;
			return false;
		case 0xa3:
			if((c_lo >= 0xb0) & (c_lo <= 0xb9) || (c_lo >= 0xc1) & (c_lo <= 0xda) ||
				 (c_lo >= 0xe1) & (c_lo <= 0xfa))
				return 2;
			return false;
		case 0xa4:
	...
	if(((c_hi == 0xa1) || ((c_hi >= 0xb0) & (c_hi <= 0xce)) ||
			((c_hi >= 0xd0) & (c_hi <= 0xf3))) &&
		 ((c_lo >= 0xa1) & (c_lo <= 0xfe)))
		return 2;
	...
	// 0xa9 - 0xa1, 0xa2, 0xa4, 0xa6, 0xa8, 0xa9, 0xab to 0xad, 0xaf, 0xb0, 0xc1
	to 0xd0
	...
	*/
		switch(c_md) {
			case 0xa2:
				...
				return false;
			case 0xa6:
				if(((c_lo >= 0xe1) & (c_lo <= 0xe5)) || (c_lo == 0xe7) ||
					 (c_lo == 0xe9) || (c_lo == 0xea) || (c_lo == 0xec) ||
					 ((c_lo >= 0xf1) & (c_lo <= 0xfc)))
					return 3;
				return false;
			case 0xa7:
				if(((c_lo >= 0xc2) & (c_lo <= 0xce)) ||
					 ((c_lo >= 0xf2) & (c_lo <= 0xfe)))
					return 3;
				return false;
			case 0xa9:
				if((c_lo == 0xa1) || (c_lo == 0xa2) || (c_lo == 0xa4) ||
					 (c_lo == 0xa6) || (c_lo == 0xa8) || (c_lo == 0xa9) ||
					 ((c_lo >= 0xab) & (c_lo <= 0xad)) || (c_lo == 0xaf) ||
					 (c_lo == 0xb0) || ((c_lo >= 0xc1) & (c_lo <= 0xd0)))
					return 3;
				return false;
			case 0xaa:
				if(((c_lo >= 0xa1) & (c_lo <= 0xb8)) ||
					 ((c_lo >= 0xba) & (c_lo <= 0xf7)))
					return 3;
				return false;
			case 0xab:
				if(((c_lo >= 0xa1) & (c_lo <= 0xbb)) ||
					 ((c_lo >= 0xbd) & (c_lo <= 0xc3)) ||
					 ((c_lo >= 0xc5) & (c_lo <= 0xf7)))
					return 3;
				return false;
